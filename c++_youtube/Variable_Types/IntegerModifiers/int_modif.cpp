...
// signed int [-2**(n-1), 2**(n-1) - 1]
// MODIFIERS only use with integers
...
int main(){
   ...
   // unsigned int value4 {-1}; //error, потому что в unsigned только неотрицательные числа можно
